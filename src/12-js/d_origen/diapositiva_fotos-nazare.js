...
window.siguiente_nazare=cargar_nazare;  
...
function cargar_nazare(incremento,parametro){
  ...
  if (h>w) {
    ...
    if (h >  600) { listado=  l.fotos.nazare_png_600_6;  c= " mediana " ; }
    if (h > 1000) { listado=  l.fotos.nazare_png_900_6;  c= " grande " ;  }
  }else {
    hv=' horizontal ';
    comentario= l.comentario_1.nazare_1; 
    listado=   l.fotos.nazare_png_300_1;  
    if (w >  600) { listado=  l.fotos.nazare_png_600_1;  c= " mediana " ; }
