...
window.siguiente_obidos=cargar_obidos;  
div.addEventListener("dblclick", () => { pantallaCompleta_obidos();})
...
function cargar_obidos(incremento,parametro){
  ...
  if (h>w) {
    ...
    if (h >  600) { listado=  l.fotos.obidos_png_600_6;  c= " mediana " ; }
    if (h > 1000) { listado=  l.fotos.obidos_png_900_6;  c= " grande " ;  }
  }else {
    hv=' horizontal ';
    comentario= l.comentario_1.obidos_1; 
    listado=   l.fotos.obidos_png_300_1;  
    if (w >  600) { listado=  l.fotos.obidos_png_600_1;  c= " mediana " ; }
