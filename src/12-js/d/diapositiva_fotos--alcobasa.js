...
window.siguiente_alcobasa=cargar_alcobasa;  
...
function CambiarAutomaticamente() { 
  ...
  cargar_alcobasa(inc,1);  
  setTimeout(CambiarAutomaticamente, t);
}
function cargar_alcobasa(incremento,parametro){
  ...
  if (h>w) {
    ...
    if (h >  600) { listado=  l.fotos.alcobasa_png_600_6;  c= " mediana " ; }
    if (h > 1000) { listado=  l.fotos.alcobasa_png_900_6;  c= " grande " ;  }
  }else {
    hv=' horizontal ';
