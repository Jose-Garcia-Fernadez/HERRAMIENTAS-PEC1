...
function cargar_obidos_video(incremento,parametro){
  ...
  c=" pequeño ";
  comentario= l.comentario_mp4.obidos_mp4; 
  listado=   l.mp4.obidos_mp4[0];  
  if (w >  600) { listado=  l.mp4.obidos_mp4[1];  c= " mediana " ; }
  if (w > 1000) { listado=  l.mp4.obidos_mp4[2];  c= " grande " ; }
