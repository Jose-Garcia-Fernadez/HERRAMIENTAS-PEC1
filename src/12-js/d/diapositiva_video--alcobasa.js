...
function cargar_alcobasa_video(incremento,parametro){
  ...
  c=" pequeño ";
  comentario= l.comentario_mp4.alcobasa_mp4; 
  listado=   l.mp4.alcobasa_mp4[0];  
  if (w >  600) { listado=  l.mp4.alcobasa_mp4[1];  c= " mediana " ; }
  if (w > 1000) { listado=  l.mp4.alcobasa_mp4[2];  c= " grande " ; }
  ...
  switch (parametro) {
    case 1:
      ...
      tiempo_video=l.duracion.alcobasa_duracion[i_listado];
      break;
    case 2: break; // ????
  }  
}
